...
const translations = {
  ...
  de: {
    htmlLang: "de",
    pageTitle: "Sportzentrum Quinta das Raposeiras | Tennis und Padel in Faro",
    pageDescription:
      "Sportzentrum Quinta das Raposeiras in Santa Barbara de Nexe, Faro. Tennis- und Padelplaetze, Akademie, Veranstaltungen, soziale Programme und Sports Bar.",
    languageSwitchAria: "Sprache waehlen",
    brandAria: "Sportzentrum Quinta das Raposeiras",
    brandLogoDefaultAlt: "Logo des Sportzentrums Quinta das Raposeiras",
    brandLogoScrolledAlt: "Vereinfachtes Logo des Sportzentrums Quinta das Raposeiras",
    menuSrOnly: "Menue oeffnen",
    navAria: "Hauptnavigation",
    navLinks: ["Club", "Info", "Services", "Programme", "Fotos", "Kontakt"],
    heroEyebrow: "Tennis • Padel • Faro, Algarve",
    heroTitleLine1: "Sportzentrum",
    heroTitlePlace: ["Quinta das", "Raposeiras"],
    heroCopy:
      "Auf dem Hoehenzug von Quinta das Raposeiras: ein Ort fuer Natur, Gemeinschaft und Sport fuer alle Altersgruppen.",
    heroActionsAria: "Hauptaktionen",
    heroButtons: ["Platz buchen", "Programme ansehen"],
    quickFactsAria: "Ueberblick der Anlagen",
    quickFactsLabels: ["Tennisplaetze", "Padelplaetze", "Montag bis Samstag", "Barrocal Algarve"],
    introKicker: "Willkommen",
    introTitle: "Sport, Freizeit und Gemeinschaft auf den Hoehen von Raposeiras.",
    introParagraphs: [
      "Das Sportzentrum Quinta das Raposeiras liegt in einem Gebiet, das vor allem auf Freizeit ausgerichtet ist. Hier verbindet sich die Ruhe mit der Natur und schafft ideale Bedingungen fuer sportliche Aktivitaet.",
      "Wir bieten einen vielfaeltigen Jahresplan mit Veranstaltungen, Services und spezifischen Tennis- und Padelprogrammen, begleitet von unserem sozialen Sports Bar Bereich.",
      "Besuchen Sie uns. Wir freuen uns auf Sie."
    ],
    clubKicker: "CDQR",
    clubTitle: "Ein Club mit Geschichte, neuer Energie und Blick nach vorn.",
    clubParagraphs: [
      "Die Tennisplaetze von Quinta das Raposeiras entstanden Ende der 70er und Anfang der 80er Jahre und gehoerten zu den ersten Plaetzen der Gemeinde Faro. Fernando Martins schuf oben auf dem Gelaende einen Bereich fuer Sport, Freizeit und Begegnung.",
      "Nach Jahren aktiver Nutzung und einer ruhigeren Phase startete Angelo Orge 2006 ein Revitalisierungsprojekt, erneuerte die Anlage und staerkte Veranstaltungen, Kommunikation und neue Infrastruktur, einschliesslich Padel."
    ],
    timelineAria: "Zeitleiste des Clubs",
    timelineThirdTag: "Heute",
    timelineTitles: ["Erste Plaetze", "Revitalisierung", "Tennis und Padel"],
    timelineParagraphs: [
      "Die Sportzone von Quinta das Raposeiras entsteht, mit Fokus auf Tennis und Gemeinschaft.",
      "Neue Leitung, Wiederherstellung der Anlagen und Neustart des sportlichen Clublebens.",
      "Regelmaessige Programme, Akademie, Turniere, Sports Bar und eine wachsende Community."
    ],
    valuesAria: "Mission, Vision und Werte",
    valueTitles: ["Mission", "Vision", "Werte"],
    valueParagraphs: [
      "Foerderung und Verbreitung sportlicher Aktivitaet, insbesondere einer nachhaltigen Entwicklung von Tennis und Padel.",
      "Gesundheit, gute koerperliche Gewohnheiten und starkes soziales Engagement mit exzellentem Service und klarem Profil verbinden.",
      "Strenge, Innovation, Qualitaet und Kompetenz in allen Leistungen des Clubs."
    ],
    infoKicker: "Info",
    infoTitle: "Lage, Oeffnungszeiten und Anlagen.",
    infoPanelTitles: ["Kontakt", "Oeffnungszeiten", "Anlagen"],
    infoAddress:
      "Sportzentrum Quinta das Raposeiras<br>Quinta das Raposeiras, Rua do Tenis<br>8005-527 Faro, Algarve, Portugal",
    infoGps: "GPS: 37 08 01.2 N 7 56 07.8 W",
    hoursDays: ["Montag bis Samstag", "Sonntage"],
    facilitiesItems: [
      "3 Tennis-Hartplaetze",
      "2 Padelplaetze",
      "Trainingswand und Mini-Tennisplatz",
      "Tennis-Clubhaus und Padel-Clubhaus",
      "Sports Bar und Umkleiden"
    ],
    servicesKicker: "Services",
    servicesTitle: "Alles, was Sie zum Spielen, Trainieren und Austauschen brauchen.",
    serviceTitles: ["Tennis Akademie", "Padel Akademie", "Veranstaltungen", "Pro Shop", "Sports Bar"],
    serviceParagraphs: [
      "Platzmiete, Gruppenkurse, Einzeltraining, Schlaeger, Baelle, Club Supporters und Besaitungsservice.",
      "Padelplaetze, Gruppenkurse, Einzeltraining, Materialverleih und technische Entwicklungsbegleitung.",
      "Turniere, Clinics, Sportcamps, Geburtstage und Programme fuer Unternehmen.",
      "Club-Merchandising, Schlaeger, Baelle, Zubehoer und Textilien fuer Tennis und Padel.",
      "Kaffee, Getraenke und Snacks fuer gute Momente nach dem Spiel."
    ],
    programsKicker: "Programme",
    programsTitle: "Sozialer und sportlicher Jahreskalender.",
    programCardSpans: ["Social Tennis", "Social Padel", "Club Supporters", "Veranstaltungen", "Pro Shop", "Summer Camp"],
    programCardTitles: [
      "\"Foxes\"",
      "\"Rapido\"",
      "Club-Spieler",
      "Tennis & Padel BBQ, Sunset Padel und mehr",
      "Ausrustung und Merchandising",
      "Sommerprogramm fuer Jugendliche"
    ],
    programCardParagraphs: [
      "Freundschaftliche Doppelspiele am Montag-, Mittwoch- und Freitagvormittag.",
      "Gemischtes Round-Robin-Format am Sonntagvormittag.",
      "Jaehrliches Spendenprogramm zur Unterstuetzung der CDQR-Aktivitaeten und Community.",
      "Wettkampforientierte und soziale Momente fuer verschiedene Altersgruppen und Spielniveaus.",
      "Unterstuetzendes Material fuer Training, Spiele, Veranstaltungen und Clubidentitaet.",
      "Vormittagsaktivitaeten im Juli, speziell fuer junge Spieler."
    ],
    programCardImageAlts: [
      "Poster des Programms Social Tennis Foxes",
      "Poster des Programms Social Padel Rapido",
      "Poster des Programms Club Supporters",
      "Poster der Veranstaltungen des Sportzentrums Quinta das Raposeiras",
      "Pro Shop Poster",
      "Poster des Programms Summer Camp 2026"
    ],
    programModalCloseAria: "Programm schliessen",
    programModalFallbackKicker: "Programm",
    programModalFallbackTitle: "Programmdetails",
    galleryKicker: "Fotos",
    galleryTitle: "Auf und neben dem Platz.",
    galleryImageAlts: [
      "Padelplatz im Sportzentrum Quinta das Raposeiras",
      "Luftaufnahme der Padelplaetze",
      "Gruppe von Teilnehmern bei einer Clubveranstaltung",
      "Besuch im Sportzentrum Quinta das Raposeiras",
      "Feier von zehn Jahren Clubgeschichte",
      "Sporttreffen in Oeiras",
      "Tennisplatz im Sportzentrum Quinta das Raposeiras",
      "Von Natur umgebene Tennisanlagen",
      "Academia Champs im Sportzentrum Quinta das Raposeiras",
      "Uebergabe eines Schlaegers an einen jungen Spieler",
      "Aktivitaet im Sportcamp",
      "Clubteilnehmer",
      "Geburtstagsfeier im Club",
      "Carlos Vilas Boas im Sportzentrum Quinta das Raposeiras",
      "Sozialbereich mit Pokalen und Erinnerungen des Clubs",
      "Titelbild des Sportzentrums Quinta das Raposeiras"
    ],
    galleryCaptions: [
      "Padel in Raposeiras",
      "Luftaufnahme der Plaetze",
      "Veranstaltungen und Community",
      "Besuche und Treffen",
      "10 Jahre Geschichte",
      "Wettkampfmomente",
      "Tennis in Raposeiras",
      "Natur und Sport",
      "Akademie und Training",
      "Generationen im Spiel",
      "Jugendaktivitaeten",
      "CDQR-Spieler",
      "Geburtstage und Gemeinschaft",
      "Besondere Besuche",
      "Erinnerungen an den Club",
      "Ueberblick ueber den Club"
    ],
    galleryPrevAria: "Vorheriges Foto",
    galleryNextAria: "Naechstes Foto",
    galleryDotsAria: "Foto auswaehlen",
    galleryDotAriaPrefix: "Foto anzeigen",
    partnersKicker: "Partnerschaften",
    partnersTitle: "Institutionen, Marken und jaehrliche Partner.",
    partnerGroupTitles: ["Institutionell und offiziell", "Jaehrlich"],
    partnerFirstList: [
      "ATA, Algarve Tennis Verband",
      "FPT, Portugiesischer Tennisverband",
      "FPP, Portugiesischer Padelverband"
    ],
    contactKicker: "Kontakt",
    contactTitle: "Buche dein naechstes Spiel in Raposeiras.",
    contactText: "Quinta das Raposeiras, Rua do Tenis, 8005-527 Faro.",
    contactEmailButton: "E-Mail senden",
    footerLogoAlt: "Sportzentrum Quinta das Raposeiras",
    footerText: "Sportzentrum Quinta das Raposeiras, Faro, Algarve.",
    footerCopyright: "© {{year}} CDQR. Tennis, Padel und Community."
  },
  sv: {
    htmlLang: "sv",
    pageTitle: "Sportcenter Quinta das Raposeiras | Tennis och Padel i Faro",
    pageDescription:
      "Sportcenter Quinta das Raposeiras i Santa Barbara de Nexe, Faro. Tennis- och padelbanor, akademi, evenemang, sociala program och Sports Bar.",
    languageSwitchAria: "Valj sprak",
    brandAria: "Sportcenter Quinta das Raposeiras",
    brandLogoDefaultAlt: "Logotyp for Sportcenter Quinta das Raposeiras",
    brandLogoScrolledAlt: "Forenklad logotyp for Sportcenter Quinta das Raposeiras",
    menuSrOnly: "Oppna meny",
    navAria: "Huvudnavigation",
    navLinks: ["Klubb", "Info", "Tjanster", "Program", "Foton", "Kontakt"],
    heroEyebrow: "Tennis • Padel • Faro, Algarve",
    heroTitleLine1: "Sportcenter",
    heroTitlePlace: ["Quinta das", "Raposeiras"],
    heroCopy:
      "Pa toppen av Quinta das Raposeiras finns en plats for natur, gemenskap och idrott for alla aldrar.",
    heroActionsAria: "Huvudatgarder",
    heroButtons: ["Boka bana", "Se program"],
    quickFactsAria: "Oversikt over anlaggningen",
    quickFactsLabels: ["tennisbanor", "padelbanor", "mandag till lordag", "Algarves barrocal"],
    introKicker: "Valkommen",
    introTitle: "Sport, fritid och gemenskap pa toppen av Raposeiras.",
    introParagraphs: [
      "Sportcenter Quinta das Raposeiras ligger i ett omrade som i huvudsak ar inriktat pa fritid, dar lugn och natur skapar idealiska forhallanden for idrott.",
      "Vi erbjuder en varierad arsplan med evenemang, tjanster och specifika program inom tennis och padel, med socialt stod fran var Sports Bar.",
      "Besok oss. Vi vantar pa dig."
    ],
    clubKicker: "CDQR",
    clubTitle: "En klubb med historia, ny energi och framtidsfokus.",
    clubParagraphs: [
      "Tennisbanorna i Quinta das Raposeiras skapades i slutet av 70-talet och borjan av 80-talet, bland de forsta banorna i Faro kommun. Fernando Martins skapade ett sportomrade pa toppen av fastigheten och erbjod invanarna en plats for fritid och gemenskap.",
      "Efter flera ars verksamhet och en period med lagre anvandning startade Angelo Orge 2006 ett projekt for att revitalisera klubben, aterstalla anlaggningen och staerka evenemang, kommunikation och ny infrastruktur, inklusive padel."
    ],
    timelineAria: "Klubbens tidslinje",
    timelineThirdTag: "Idag",
    timelineTitles: ["Forsta banorna", "Revitalisering", "Tennis och padel"],
    timelineParagraphs: [
      "Sportomradet i Quinta das Raposeiras skapas med fokus pa tennis och gemenskap.",
      "Ny ledning, aterstallning av anlaggningen och nystart for klubbens idrottsliv.",
      "Regelbundna program, akademi, turneringar, Sports Bar och en vaxtande gemenskap."
    ],
    valuesAria: "Mission, vision och varderingar",
    valueTitles: ["Mission", "Vision", "Varderingar"],
    valueParagraphs: [
      "Framja och sprida idrottsutovning, sarskilt hallbar utveckling av tennis och padel.",
      "Kombinera halsa, goda fysiska vanor och starkt socialt engagemang med hog servicekvalitet och tydlig profil.",
      "Noggrannhet, innovation, kvalitet och kompetens i allt klubben gor."
    ],
    infoKicker: "Info",
    infoTitle: "Plats, oppettider och anlaggningar.",
    infoPanelTitles: ["Kontakt", "Oppettider", "Anlaggningar"],
    infoAddress:
      "Sportcenter Quinta das Raposeiras<br>Quinta das Raposeiras, Rua do Tenis<br>8005-527 Faro, Algarve, Portugal",
    infoGps: "GPS: 37 08 01.2 N 7 56 07.8 W",
    hoursDays: ["Mandag till lordag", "Sondagar"],
    facilitiesItems: [
      "3 hardcourt-tennisbanor",
      "2 padelbanor",
      "Traningsvagg och mini-tennisbana",
      "Tennisklubbhus och padelklubbhus",
      "Sports Bar och omkladningsrum"
    ],
    servicesKicker: "Tjanster",
    servicesTitle: "Allt du behover for att spela, trana och umgas.",
    serviceTitles: ["Tennisakademi", "Padelakademi", "Evenemang", "Pro Shop", "Sports Bar"],
    serviceParagraphs: [
      "Banhyra, grupplektioner, privata lektioner, racketar, bollar, club supporters och strangning.",
      "Padelbanor, grupplektioner, individuell traning, materialuthyrning och teknisk utvecklingscoachning.",
      "Turneringar, clinics, sportlager, fodelsedagar och foretagsprogram.",
      "Klubbmerchandise, racketar, bollar, tillbehor och textilier for tennis och padel.",
      "Kaffe, drycker och snacks for att forlaenga spelet med trevliga stunder utanfor banan."
    ],
    programsKicker: "Program",
    programsTitle: "Social och sportig agenda hela aret.",
    programCardSpans: ["Social Tennis", "Social Padel", "Club Supporters", "Evenemang", "Pro Shop", "Summer Camp"],
    programCardTitles: [
      "\"Foxes\"",
      "\"Rapido\"",
      "Klubbspelare",
      "Tennis & Padel BBQ, Sunset Padel och mer",
      "Utrustning och merchandise",
      "Ungdomsprogram pa sommaren"
    ],
    programCardParagraphs: [
      "Vanliga dubbelmatcher pa mandag, onsdag och fredag morgon.",
      "Mixat round-robin-format pa sondagsmorgnar.",
      "Arligt donationsprogram for att stodja CDQR:s verksamhet och gemenskap.",
      "Tavlings- och sociala tillfallen for olika aldrar och spelnivaer.",
      "Stodmaterial for traning, matcher, evenemang och klubbidentitet.",
      "Morgonaktiviteter under juli, utformade for unga spelare."
    ],
    programCardImageAlts: [
      "Affisch for Social Tennis Foxes-programmet",
      "Affisch for Social Padel Rapido-programmet",
      "Affisch for Club Supporters-programmet",
      "Affisch for evenemang pa Sportcenter Quinta das Raposeiras",
      "Pro Shop-affisch",
      "Affisch for Summer Camp 2026-programmet"
    ],
    programModalCloseAria: "Stang program",
    programModalFallbackKicker: "Program",
    programModalFallbackTitle: "Programdetaljer",
    galleryKicker: "Foton",
    galleryTitle: "Pa och utanfor banan.",
    galleryImageAlts: [
      "Padelbana pa Sportcenter Quinta das Raposeiras",
      "Flygbild over padelbanorna",
      "Grupp deltagare vid ett klubbevenemang",
      "Besok pa Sportcenter Quinta das Raposeiras",
      "Firande av tio ar av klubbens historia",
      "Sporttraff i Oeiras",
      "Tennisbana pa Sportcenter Quinta das Raposeiras",
      "Tennisanlaggning omgiven av natur",
      "Academia Champs pa Sportcenter Quinta das Raposeiras",
      "Racket delas ut till en ung spelare",
      "Aktivitet pa sportlager",
      "Klubbdeltagare",
      "Fodelsedagsfirande i klubben",
      "Carlos Vilas Boas pa Sportcenter Quinta das Raposeiras",
      "Social yta med pokaler och klubbminnen",
      "Omslagsbild for Sportcenter Quinta das Raposeiras"
    ],
    galleryCaptions: [
      "Padel i Raposeiras",
      "Flygbild over banorna",
      ...
      "Ungdomsaktiviteter",
      "CDQR-spelare",
      "Fodelsedagar och gemenskap",
      "Sarskilda besok",
      "Klubbminnen",
      "Oversikt av klubben"
    ],
    galleryPrevAria: "Forra foto",
    galleryNextAria: "Nasta foto",
    galleryDotsAria: "Valj foto",
    galleryDotAriaPrefix: "Visa foto",
    partnersKicker: "Partnerskap",
    partnersTitle: "Institutioner, varumarken och arliga partners.",
    partnerGroupTitles: ["Institutionella och officiella", "Arliga"],
    partnerFirstList: [
      "ATA, Algarve Tennisforbund",
      "FPT, Portugisiska Tennisforbundet",
      "FPP, Portugisiska Padelforbundet"
    ],
    contactKicker: "Kontakt",
    contactTitle: "Boka din nasta match i Raposeiras.",
    contactText: "Quinta das Raposeiras, Rua do Tenis, 8005-527 Faro.",
    contactEmailButton: "Skicka e-post",
    footerLogoAlt: "Sportcenter Quinta das Raposeiras",
    footerText: "Sportcenter Quinta das Raposeiras, Faro, Algarve.",
    footerCopyright: "© {{year}} CDQR. Tennis, padel och gemenskap."
  },
  nl: {
    htmlLang: "nl",
    pageTitle: "Sportcentrum Quinta das Raposeiras | Tennis en Padel in Faro",
    pageDescription:
      "Sportcentrum Quinta das Raposeiras in Santa Barbara de Nexe, Faro. Tennis- en padelbanen, academie, evenementen, sociale programma's en Sports Bar.",
    languageSwitchAria: "Taal kiezen",
    brandAria: "Sportcentrum Quinta das Raposeiras",
    brandLogoDefaultAlt: "Logo van Sportcentrum Quinta das Raposeiras",
    brandLogoScrolledAlt: "Vereenvoudigd logo van Sportcentrum Quinta das Raposeiras",
    menuSrOnly: "Menu openen",
    navAria: "Hoofdnavigatie",
    navLinks: ["Club", "Info", "Diensten", "Programma's", "Foto's", "Contact"],
    heroEyebrow: "Tennis • Padel • Faro, Algarve",
    heroTitleLine1: "Sportcentrum",
    heroTitlePlace: ["Quinta das", "Raposeiras"],
    heroCopy:
      "Op de top van Quinta das Raposeiras vind je een plek voor natuur, ontmoeting en sport voor alle leeftijden.",
    heroActionsAria: "Hoofdacties",
    heroButtons: ["Baan reserveren", "Programma's bekijken"],
    quickFactsAria: "Overzicht van de faciliteiten",
    quickFactsLabels: ["tennisbanen", "padelbanen", "maandag t/m zaterdag", "barrocal van de Algarve"],
    introKicker: "Welkom",
    introTitle: "Sport, vrije tijd en gemeenschap op de top van Raposeiras.",
    introParagraphs: [
      "Sportcentrum Quinta das Raposeiras ligt in een gebied dat vooral gericht is op vrije tijd, waar rust en natuur samenkomen en ideale omstandigheden creeren voor sportbeoefening.",
      "Wij bieden een gevarieerd jaarprogramma met evenementen, diensten en specifieke tennis- en padelprogramma's, ondersteund door onze sociale Sports Bar.",
      "Kom langs. We wachten op je."
    ],
    clubKicker: "CDQR",
    clubTitle: "Een club met geschiedenis, nieuwe energie en blik op de toekomst.",
    clubParagraphs: [
      "De tennisbanen van Quinta das Raposeiras ontstonden eind jaren 70 en begin jaren 80, als een van de eerste banen in de gemeente Faro. Fernando Martins creerde boven op het terrein een sportzone voor ontspanning en ontmoeting.",
      "Na jaren van activiteit en een periode van minder gebruik startte Angelo Orge in 2006 een revitaliseringsproject voor de club, met herstel van de ruimte en versterking van evenementen, communicatie en nieuwe infrastructuur, inclusief padel."
    ],
    timelineAria: "Tijdlijn van de club",
    timelineThirdTag: "Vandaag",
    timelineTitles: ["Eerste banen", "Revitalisering", "Tennis en padel"],
    timelineParagraphs: [
      "De sportzone van Quinta das Raposeiras wordt gecreeerd, gericht op tennis en ontmoeting.",
      "Nieuw management, herstel van de faciliteiten en herlancering van het sportieve clubleven.",
      "Regelmatige programma's, academie, toernooien, Sports Bar en een groeiende community."
    ],
    valuesAria: "Missie, visie en waarden",
    valueTitles: ["Missie", "Visie", "Waarden"],
    valueParagraphs: [
      "Het bevorderen en verspreiden van sportbeoefening, met name de duurzame ontwikkeling van tennis en padel.",
      "Gezondheid, goede fysieke gewoonten en sterke sociale betrokkenheid combineren met uitstekende service en onderscheidend vermogen.",
      "Nauwkeurigheid, innovatie, kwaliteit en competentie in alle acties van de club."
    ],
    infoKicker: "Info",
    infoTitle: "Locatie, openingstijden en faciliteiten.",
    infoPanelTitles: ["Contact", "Openingstijden", "Faciliteiten"],
    infoAddress:
      "Sportcentrum Quinta das Raposeiras<br>Quinta das Raposeiras, Rua do Tenis<br>8005-527 Faro, Algarve, Portugal",
    infoGps: "GPS: 37 08 01.2 N 7 56 07.8 W",
    hoursDays: ["Maandag t/m zaterdag", "Zondagen"],
    facilitiesItems: [
      "3 hardcourt-tennisbanen",
      "2 padelbanen",
      "Trainingsmuur en mini-tennisbaan",
      "Tennisclubhuis en padelclubhuis",
      "Sports Bar en kleedkamers"
    ],
    servicesKicker: "Diensten",
    servicesTitle: "Alles wat je nodig hebt om te spelen, te trainen en samen te komen.",
    serviceTitles: ["Tennisacademie", "Padelacademie", "Evenementen", "Pro Shop", "Sports Bar"],
    serviceParagraphs: [
      "Baanverhuur, groepslessen, privelessen, rackets, ballen, club supporters en bespanningsservice.",
      "Padelbanen, groepslessen, individuele training, verhuur van materiaal en technische begeleiding.",
      "Toernooien, clinics, sportkampen, verjaardagen en programma's voor bedrijven.",
      "Clubmerchandising, rackets, ballen, accessoires en textiel voor tennis en padel.",
      "Koffie, drankjes en snacks om het spel te verlengen met fijne momenten buiten de baan."
    ],
    programsKicker: "Programma's",
    programsTitle: "Sociale en sportieve agenda het hele jaar door.",
    programCardSpans: ["Social Tennis", "Social Padel", "Club Supporters", "Evenementen", "Pro Shop", "Summer Camp"],
    programCardTitles: [
      "\"Foxes\"",
      "\"Rapido\"",
      "Clubspelers",
      "Tennis & Padel BBQ, Sunset Padel en meer",
      "Uitrusting en merchandising",
      "Zomerprogramma voor jongeren"
    ],
    programCardParagraphs: [
      "Vriendschappelijke dubbelwedstrijden op maandag-, woensdag- en vrijdagochtend.",
      "Gemengd round-robin-formaat op zondagochtend.",
      "Jaarlijks donatieprogramma ter ondersteuning van CDQR-activiteiten en community.",
      "Competitieve en sociale momenten voor verschillende leeftijden en niveaus.",
      "Ondersteunend materiaal voor training, wedstrijden, evenementen en clubidentiteit.",
      "Ochtendactiviteiten in juli, ontworpen voor jonge spelers."
    ],
    programCardImageAlts: [
      "Poster van het Social Tennis Foxes-programma",
      "Poster van het Social Padel Rapido-programma",
      "Poster van het Club Supporters-programma",
      "Poster van evenementen van Sportcentrum Quinta das Raposeiras",
      "Pro Shop-poster",
      "Poster van het Summer Camp 2026-programma"
    ],
    programModalCloseAria: "Programma sluiten",
    programModalFallbackKicker: "Programma",
    programModalFallbackTitle: "Programmadetails",
    galleryKicker: "Foto's",
    galleryTitle: "Op en buiten de baan.",
    galleryImageAlts: [
      "Padelbaan van Sportcentrum Quinta das Raposeiras",
      "Luchtfoto van de padelbanen",
      "Groep deelnemers bij een clubevenement",
      "Bezoek aan Sportcentrum Quinta das Raposeiras",
      "Viering van tien jaar clubgeschiedenis",
      "Sportbijeenkomst in Oeiras",
      "Tennisbaan van Sportcentrum Quinta das Raposeiras",
      "Tennisfaciliteiten omringd door natuur",
      "Academia Champs in Sportcentrum Quinta das Raposeiras",
      "Racket gegeven aan een jonge speler",
      "Activiteit in sportkamp",
      "Clubdeelnemer",
      "Verjaardag in de club",
      "Carlos Vilas Boas in Sportcentrum Quinta das Raposeiras",
      "Sociale ruimte met trofeeen en clubherinneringen",
      "Omslagfoto van Sportcentrum Quinta das Raposeiras"
    ],
    galleryCaptions: [
      "Padel in Raposeiras",
      "Luchtfoto van de banen",
      "Evenementen en community",
      "Bezoeken en ontmoetingen",
      "10 jaar geschiedenis",
      "Competitieve momenten",
      "Tennis in Raposeiras",
      "Natuur en sport",
      "Academie en training",
      "Generaties in het spel",
      "Jeugdactiviteiten",
      "CDQR-spelers",
      "Verjaardagen en gezelligheid",
      "Bijzondere bezoeken",
      "Clubherinneringen",
      "Overzicht van de club"
    ],
    galleryPrevAria: "Vorige foto",
    galleryNextAria: "Volgende foto",
    galleryDotsAria: "Foto selecteren",
    galleryDotAriaPrefix: "Foto tonen",
    partnersKicker: "Partners",
    partnersTitle: "Instellingen, merken en jaarlijkse partners.",
    partnerGroupTitles: ["Institutioneel en officieel", "Jaarlijks"],
    partnerFirstList: [
      "ATA, Algarve Tennisvereniging",
      "FPT, Portugese Tennisfederatie",
      "FPP, Portugese Padelfederatie"
    ],
    contactKicker: "Contact",
    contactTitle: "Boek je volgende wedstrijd in Raposeiras.",
    contactText: "Quinta das Raposeiras, Rua do Tenis, 8005-527 Faro.",
    contactEmailButton: "E-mail sturen",
    footerLogoAlt: "Sportcentrum Quinta das Raposeiras",
    footerText: "Sportcentrum Quinta das Raposeiras, Faro, Algarve.",
    footerCopyright: "© {{year}} CDQR. Tennis, padel en community."
  }
};
